...
/*
class ProposalContractForm extends Component {
...
ProposalContractForm.contextTypes = {
...
export default drizzleConnect(ProposalContractForm, mapStateToProps)

export {
  ProposalContractForm
}
*/
